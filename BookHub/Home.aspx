<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="BookHub.Home" %>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="home.html">Warranty</a></li>
                <li><a href="home.html">Shipping</a></li>
...
<main>
    <div class="banner">
        ...
        <img src="book1-removebg-preview.png" alt="a book">
    </div>
    <div class="benefits">
    ...
    <div class="product-container">
        ...
        <div class="slider-wrapper swiper">
            <div id="bookContainer" class="product-list swiper-wrapper" runat="server"></div>
        </div>
    </div>
    <div class="subscribe">
...
<!--https://www.figma.com/design/eyFZeRQ95xFkzpuPSzcJWd/Untitled?node-id=2-140&m=dev-->
